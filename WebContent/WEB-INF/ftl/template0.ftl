  ...
  <div class="container-fluid container-nav">       
    ...
    <div class="navbar-right">
      ...
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <span class="name">开发者<!-- <@shiro.principal /> --></span>
            </div>      
...
<div class="sidebar">
  <div class="sidebar-collapse">
    ...
    <nav id="menu" class="nav-main" role="navigation">
        ...
        <#-- 菜单动态加载 -->
             <li>
         <a href="#"><i class="fa fa-group fa-fw" aria-hidden="true"></i> 船舶管理<span class="fa arrow"></span></a>
           <ul class="nav nav-second-level"> 
             <li>
                <a ref="csm-s001" href="#" rel="/shipperManagement-demo/shipperReleaseInqury.ftl"><span class="text nav_txt">我要询价</span></a>
              </li>
          </ul>
        </li>
      </ul>
...
<#macro tJSBox>
  ...
  <!-- jQuery -->
    ...
    <script src="${request.contextPath}/static/js/formatDate.js"></script>
    ...
    <!-- datatable-user -->
    <script src="${request.contextPath}/static/js/datatable-user.js"></script>
